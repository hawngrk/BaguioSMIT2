...
//search screening patient
if (isset($_POST['searchScreeningPatient'])) {
    $searchPatient = $_POST['searchScreeningPatient'];
    if ($searchPatient == "") {
    ...
    while ($stmt->fetch()) {
        echo "<tr class='tableCenterCont'>
                ...
                <td class='columnName'>
                <button class='addVitals btn-info btn-sm' type='submit' onclick='clickModalRow($patientID)'>Add Vitals</button>
                </td>
                </tr>";
    }
}
