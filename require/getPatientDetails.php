...
$stmt->prepare($query);
$stmt->execute();
$stmt->bind_result($patientDeetsPatId, $patientFName, $patientLName, $patientMName, $patientSuffix, $patientPrioGroup, $patientCatId, $patientCatNum, $patientHAddress, $patientCity, $patientProv, $patientReg, $patientBirth, $age, $gender, $contact, $occupation);
