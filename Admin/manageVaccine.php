<!---/***
* @Author Hudson Kit P. Natividad & Leslie Joy Palma
...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <!-- Page Content  -->
        <button id="addVaccineBtn" type="button" class="buttonTop">
            Add Vaccine
        </button>
        ...
        <button id="addNewVaccineBtn" type="button" class="buttonTop">
            Add New Vaccine
        </button>
